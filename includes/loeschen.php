...
<body>
    ...
    if ($besitzer !='0'){
        ...
        $stmt3 = $pdo->prepare("DELETE FROM dbzuweisung WHERE dateiid=:dateiid "); //Hier muss als Bedingung noch die userid im hashwert einbezogen werden, da ja der datainame nicht eindeutig ist
