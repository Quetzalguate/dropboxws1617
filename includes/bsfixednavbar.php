            ...
            <div class="text-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="">An</a><button onclick="document.body.style.backgroundColor = 'green';">Green</button></li> <!-- https://mars.iuk.hdm-stuttgart.de/~jv029/includes/background1.php?var=1-->
