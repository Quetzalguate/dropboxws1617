        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="https://mars.iuk.hdm-stuttgart.de/~jv029/upload.php"><img class="icon icons8-Upload" src="data:image/png;base64," width="15" height="15"> Upload</a></li>
                    <li><a href="https://mars.iuk.hdm-stuttgart.de/~jv029/suchen.php"><img class="icon icons8-Search" src="data:image/png;base64," width="15" height="15"> Suche</a></li>
            ...
            <div class="text-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <button onclick="document.body.style.backgroundColor = 'white';">an</button><!-- https://mars.iuk.hdm-stuttgart.de/~jv029/includes/background1.php?var=1-->
                        <button onclick="document.body.style.backgroundColor = 'rgba(0, 0, 0, 0.6)';">aus</button><!-- <li><a href="https://mars.iuk.hdm-stuttgart.de/~jv029/includes/background1.php?var=0">Aus</a></li>-->
                    </ul>
                </div>
            </div>
        </div>
